...
onMounted( async ()=>{
    try{
        const response = await api.get("/admin/view/all/drives");
    ...
    <div class="main">
        <div class="left">
            ...
            <div class="links">
                ...
                <router-link to="/admin/view/drives"><button class="btn1">Drives</button></router-link>
        ...
        <div class="right">
            <div class="right_left">
                <div class="right_head">
                    <p class="right-head">Drives</p>
                    <input type="search" class="search" placeholder="Search here" v-model="search">
                </div>
                <p class="no_data" v-if="(drives.length) === 0 || searchDrive.length === 0">No drives</p>

                <div class="right_main_body" tabindex="0" v-if="(drives.length) !== 0 && searchDrive.length !== 0">
                    <div class="titles">
                        <p>Id</p>
                        <p>Title</p>
                        <p>Recruiter</p>
                    ...
                    <div class="values" v-for="drive in searchDrive" @click="viewName(drive.id)">
                        <p>{{ drive.id }}</p>
                        <p>{{ drive.title }}</p>
                        <p>{{ drive.recruiter }}</p>
                        <p>{{ drive.status }}</p>
            ...
            <div class="right_right" v-if="check">
                ...
                <div class="links3">
                    ...
                    <button class="det2 d">Delete Drive</button>
                </div>
            </div>
        </div>
    </div>
